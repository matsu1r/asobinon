---
title: 目が合うと死亡! 向いている視点の方向を判定するrx/ryを使った仕掛けの作り方[コマンド解説]
---
...
- [目次](#目次)
- [今回作る仕掛け -目を合わせてはいけない人形、ピーチ城再現-](#今回作る仕掛け--目を合わせてはいけない人形ピーチ城再現-)
- [目を合わせるとダメージを受ける人形の作り方](#目を合わせるとダメージを受ける人形の作り方)
- [マリオ64のピーチ城のように、上を向くとワープする仕掛けの作り方](#マリオ64のピーチ城のように上を向くとワープする仕掛けの作り方)
- [プレイヤーの視点の向きを判定する数値一覧 – 全方角を網羅!](#プレイヤーの視点の向きを判定する数値一覧--全方角を網羅)
  - [新引数「ry」の書き方 – 横方向の視点の向き、つまり方角を判定](#新引数ryの書き方--横方向の視点の向きつまり方角を判定)
  - [新引数「rx」の書き方 – 縦方向の視点の向き、つまり上下の向きを判定](#新引数rxの書き方--縦方向の視点の向きつまり上下の向きを判定)
