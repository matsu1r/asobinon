...
*   [スキンパック・マッシュアップパックなどDLC関連のこと](#store)
    *   [「北欧神話マッシュアップパック」が登場](#north)
    *   [「PSエディション4周年記念スキンパック」と「1/2/3周年記念スキンパック」が登場](#anniv)
*   [ミニゲームに関すること](#minigame)
    *   [転落ミニゲームにフェスティバルなアリーナが追加](#festive)
*   [Mobに関すること](#mob)
    *   [ウマ/ロバ/ラバのモデルがシンプルなものに変更](#horse)
    *   [ウィザーがBEに合わせた挙動に、ウィザスケ召喚能力などを備えたぞ](#wither)
    *   [赤ちゃんゾンビが全てのMobに乗れるように](#jockey)
*   [ワールドの生成に関すること](#world)
    *   [村が氷原・極寒タイガバイオームに生成されるように](#village)
    *   [テーブルがカーペットになるなど、村の中身が変更](#village-change)
    *   [BEのように、倒木や枯れかけた木(ツタが生えた木)が生成されるように](#trees)
*   [アイテム・ブロックに関すること](#item-block)
    *   [大釜にポーションや水を入れられるように、矢や染色に使えるぞ](#cauldron)
    *   [「革の馬鎧」が追加、染色可能](#horse-armor)
    *   [防具立てのポーズを変更できるように](#armor-stand)
    *   [花火を好きな方向に発射できるようになった](#fireworks)
    *   [分配装置(ディスペンサー)で、Mobを召喚できない場合はMobの頭はドロップするように](#mobhead)
    *   [サトウキビに骨粉が使えるようになった](#suger)
    *   [草のテクスチャが変わった](#shrubs)
