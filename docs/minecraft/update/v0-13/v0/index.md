...
*   ウサギを倒すと、「[ウサギの皮](#rabbit-items)」「[生の兎肉](#rabbit-items)」を落とす。
*   **2.5%の確率で「ウサギの足」を落とす。**「ウサギの足」を使えば、跳躍のポーションが作れる。
...
[マツ/シラカバ/熱帯樹(ジャングル)/アカシア/ダークオークのドア](#add-doors)

各種類の木材x6

[鉄のドア](#iron-door) (今バージョンでクラフト可能に)
