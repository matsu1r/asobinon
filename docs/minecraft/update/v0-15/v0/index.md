...
slug: /minecraft-je/howto/pe-alpha-015
description: “The Friendly Update”―待望のウマやピストン、ジャングルの寺院などがついにやって来ました。この記事では、マイクラPEの最新バージョン「0.15.0」アップデート内容をまとめました。 開発者さんのツイート、公式Wikiの情報を翻訳しつつ画像付きで詳しくまとめています。
---
...
*   [モブ(動物、敵キャラ等)に関する追加/変更点](#mob)
    *   [ついに「ウマ(馬)/ロバ/ラバ」を追加! 懐かせてサドルを付け、走ったりジャンプしたり](#horse)
    *   [新しいタイプのスケルトン「ストレイ(Stray)」が追加された](#stray)
    *   [新しいタイプのゾンビ「ハスク(Husk)」が追加された](#hask)
    *   [エンダーマンが、まれにネザーにスポーンするようになった New](#enderman-in-nether)
    *   [PC版1.9のように、スケルトンが戦闘時だけ弓を構えるようになった](#skeleton)
*   [ワールドの生成(ダンジョンや構造物)に関する追加/変更点](#world)
    *   [新構造物「ジャングルの寺院」が生成されるようになった](#jungle-temple)
    *   [タイガと雪原バイオームにも村が生成されるようになり、サバンナ村の木材が変わった](#village)
    *   [「ゾンビ村」らしき村が生成されるようになった。建物は苔むして村人ゾンビだらけ!](#zombie-village)
*   [システム(ゲーム全体)に関する新要素と変更点](#system)
    *   [フレンドとのマルチプレイや実績などの機能に「XboxLiveアカウント」が必要になった。作成とサインインは無料です New](#xboxlive)
    *   [XboxLiveアカウントを使って、遠く離れた友達とマルチプレイできるようになった _内容更新!_](#friend-multi)
    *   [各種の「実績」や、プレイ時間が記録されるように。XboxLiveアカウントが必要](#achievement)
    *   [「テクスチャーパック」を使えるようになったが、課金して購入せねば使えない New](#texture)
    *   [有料のレンタルサーバーサービス「Realms」が使えるようになった New](#realms)
    *   [タイトル画面に「ストア」が出現、スキンとテクスチャが販売されている New](#store)
    *   [Windows10版の設定に「テクセル アンチエイリアシング」が追加された New](#texel-aa)
*   [ゲームプレイに関する追加/変更点](/pe-alpha-015/2/#gameplay)
    *   [インベントリのアイテムをダブルタップして、好きな場所に並び替えできるようになった](/pe-alpha-015/2/#item-sort)
    *   [大釜を使って、矢にポーション効果を付けられるように](/pe-alpha-015/2/#cauldron-arrow)
    *   [雷が落ちた場所にスケルトン馬が出現する「スケルトントラップ」が発動するようになった New](/pe-alpha-015/2/#skeleton-trap)
    *   [クリエイティブモードで下降中はスニーク状態になるようになった New](/pe-alpha-015/2/#down-sneak)
    *   [矢を撃つ際に、矢が手持ちとインベントリの左から順に選ばれるように](/pe-alpha-015/2/#sort-arrow)
    *   [ついにブタに乗れるようになった。ニンジン付きの棒で加速できる](/pe-alpha-015/2/#ride-pig)
*   [ブロックやアイテムの追加、変更点](/pe-alpha-015/2/#block-and-item)
    *   [馬の装備「馬鎧(うまよろい)」を追加。クラフト/染色出来る「革の馬鎧」もあるぞ](/pe-alpha-015/2/#horse-armor)
    *   [PC版1.9の新要素「ポーション効果付き矢」を追加、矢を当てて毒などを与えよう](/pe-alpha-015/2/#potion-arrow)
    *   [ついに**「ピストン」「粘着ピストン」を追加**! 作れる装置の幅が大きく広がる](/pe-alpha-015/2/#piston)
    *   [ブロックの状態変化を検知する「観察者(Observer)」が追加、つまり”BUDブロック” _内容更新!_](/pe-alpha-015/2/#bud)
    *   [「生の羊肉」「焼いた羊肉(ジンギスカン)」を追加](/pe-alpha-015/2/#mutton)
    *   [「ファイアチャージ」(火打ち石の代わりになるアイテム)が追加された](/pe-alpha-015/2/#fire-charge)
    *   [ペットや動物などに名前を付けられる「名札」が追加された _内容更新!_](/pe-alpha-015/2/#nametag)
    *   [ペットや動物を引っ張れる「リード(ロープ、縄、紐)」が追加された](/pe-alpha-015/2/#lead)
    *   [「ニンジン付きの棒(棒付きのニンジン)」が追加された。ブタの操作に使う](/pe-alpha-015/2/#cos)
    *   [トラップドアを地面に直接置ける/空中に浮かせられるようになった](/pe-alpha-015/2/#trapdoor)
...
![みんな村人ゾンビ](https://cdn-ak.f.st-hatena.com/images/fotolife/s/sasigume/20210208/20210208110529.png)
...
### 「テクスチャーパック」を使えるようになったが、課金して購入せねば使えない
...
### インベントリのアイテムをダブルタップして、好きな場所に並び替えできるようになった
...
![ブタの操作と加速](https://res.cloudinary.com/napoan-com/image/upload/w_650,c_limit,f_auto,q_auto/v1578381098/ea58e25c6792fa289f84c9a97ae10a9a_e6mbho.png)
...
![ピストン](https://res.cloudinary.com/napoan-com/image/upload/w_650,c_limit,f_auto,q_auto/v1578381094/f95cc761552ce72226c2748c9d5268e9_vtp4s0.png)
...
![ファイアチャージ](https://cdn-ak.f.st-hatena.com/images/fotolife/s/sasigume/20210208/20210208092418.png)
...
### 「ニンジン付きの棒(棒付きのニンジン)」が追加された。ブタの操作に使う
