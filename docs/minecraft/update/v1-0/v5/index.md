...
slug: /minecraft-je/howto/pe-105-update
...
*   [3種類のコマンドブロックが追加された](#blocks)
*   [testforやeffectなど、11種類のコマンドが追加された](#commands)
*   [コマンドブロック付きトロッコが追加された](#cart)
*   [エンティティ(Mob等)が消える問題が改善された](#mob)
*   [Power Rangersスキンパックが追加された](#skinpack)
