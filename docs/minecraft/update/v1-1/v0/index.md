...
slug: /minecraft-je/howto/pe-update-11
...
*   [ワールドの生成(ダンジョンや構造物)に関する追加/変更点](#world)
    *   [ダークオークの森に「森の洋館(森林の邸宅)」が生成されるように。新Mobが待っているぞ](#mansion)
    *   [シード値が同じでも、同じ場所に建物が生成されるわけではなくなった](#seed-generation)
*   [モブ(動物、敵キャラ等)に関する追加/変更点](#mob)
    *   [「ラマ」を追加。操作はできないが乗ることはできる友好Mob](#llama)
    *   [「ヴィンディケーター」を追加。森の洋館に住んでいる邪悪な村人](#vindicator)
    *   [「エヴォーカー」を追加。森の洋館に住んでいる邪悪な村人](#evoker)
    *   [「ヴェックス」を追加。エヴォーカーが召喚するお化けのような敵Mob](#vex)
    *   [新しい村人の職業「製図家」を追加。「宝の地図」を買えるぞ](#cartographer)
    *   [村人ゾンビの鳴き声が、PC版と同じ独特のものに](#zb-voice)
    *   [シュルカーの色が少し変わった](#shulker-color)
*   [ブロックやアイテムの追加、変更点](/pe-update-11/2/#block-and-item)
    *   [新ブロック「セメント (コンクリートパウダー)」を追加。16色に染めることができる](/pe-update-11/2/#con-powder)
    *   [新ブロック「コンクリート」を追加。セメントと水が触れるとコンクリートになる](/pe-update-11/2/#concrete)
    *   [新ブロック「彩釉テラコッタ」を追加。色付き堅焼き粘土に模様が付いたもの](/pe-update-11/2/#terraccotta)
    *   [新ブロック「シュルカーボックス」を追加。壊しても中身が保持される箱](/pe-update-11/2/#shulker-box)
    *   [新アイテム「不死のトーテム」を追加。エヴォーカーが落とす便利アイテム](/pe-update-11/2/#totem)
    *   [「宝の地図」を追加。森の洋館や海底神殿の位置が分かる](/pe-update-11/2/#explorer-map)
    *   [ベッドを16色に染められるように。また、上に乗ると少し跳ねる&ゆっくり眠りにつくように](/pe-update-11/2/#bed)
    *   [金/鉄の道具武器防具を精錬すると、金塊/鉄塊が入手できるように](/pe-update-11/2/#tool-nugget)
    *   [新アイテム「鉄塊」を追加。9個で鉄インゴット1個になる](/pe-update-11/2/#iron-nugget)
    *   [クモの巣をクラフトすることで糸9個が手に入るように](/pe-update-11/2/#web-to-string)
    *   [スイカをハサミで収穫すると一度に9個ドロップするように](/pe-update-11/2/#melon)
    *   [地図に番号が割り当てられるようになった+コンパスの有無が分かりやすくなった](/pe-update-11/2/#map-number)
    *   [羊毛とカーペットの色が少し変わった](/pe-update-11/2/#wool)
*   [ゲームプレイに関する追加/変更点](/pe-update-11/3/#gameplay)
    *   [装備スロットに加えて「オフハンドスロット」が追加された (ただし矢と不死のトーテム専用)](/pe-update-11/3/#offhand)
    *   [新エンチャント「修繕」と「氷上歩行(氷渡り)」が追加された](/pe-update-11/3/#enchantment)
    *   [gameruleコマンドで設定できるゲームルールが8種類追加された。時間を止めたりできる](/pe-update-11/3/#gamerule)
    *   [新ゲームモード「アドベンチャーモード」が追加。コマンドで切り替え可能](/pe-update-11/3/#adventure)
    *   [マルチプレイの上限人数を設定する「setmaxplayers」コマンドを追加 New!!](/pe-update-11/3/#setmax)
    *   [replaceitemコマンドで「CanPlaceOn」「CanDestroy」のコンポーネントが使えるようになった](/pe-update-11/3/#replaceitem)
*   [システム(ゲーム全体)に関する新要素と変更点](/pe-update-11/3/#system)
    *   [「ストア」でプロのクリエイター達のワールドやテクスチャなどが販売されるように](/pe-update-11/3/#market)
    *   [ビデオ設定で「スムースライティング」をON/OFFできるようになった](/pe-update-11/3/#smooth)
