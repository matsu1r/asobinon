...
この利用規約（以下，「本規約」といいます。）は、[Markdown Gaming](https://md.napoan.com)（以下，「当サイト」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
...
5. 以下、「レポジトリ」は[GitHub上のレポジトリ](https://github.com/imaicu/markdown-gaming)を指します。
